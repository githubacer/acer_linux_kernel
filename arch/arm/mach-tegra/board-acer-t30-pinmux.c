...
static __initdata struct tegra_pingroup_config picasso2_pinmux_common[] = {
	...
	DEFAULT_PINMUX(SPDIF_IN,        DAP2,            NORMAL, NORMAL,     OUTPUT), // G (NC)
	...
	DEFAULT_PINMUX(KB_ROW4,         OWR,             NORMAL,    NORMAL,     OUTPUT), // G (NC)
	DEFAULT_PINMUX(KB_ROW5,         OWR,             NORMAL,    NORMAL,     OUTPUT), // G
	DEFAULT_PINMUX(KB_ROW6,         OWR,             NORMAL,    NORMAL,     OUTPUT), // G (NC)
	DEFAULT_PINMUX(KB_ROW7,         OWR,             NORMAL,    NORMAL,     OUTPUT), // G
	DEFAULT_PINMUX(KB_ROW8,         KBC,             PULL_DOWN,   TRISTATE,     INPUT), //GI
	DEFAULT_PINMUX(KB_ROW9,         OWR,             NORMAL,    NORMAL,     OUTPUT), // G (NC)
