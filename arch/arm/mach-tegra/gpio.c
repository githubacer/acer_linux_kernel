...
static struct gpio_table gpio_sleep_init_table[] = {
	...
	GPIO_CONFIG(NULL, TEGRA_GPIO_PZ1, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC1_CMD (SDMMC_CMD)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PY7, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC1_DAT0 (SDMMC_DAT0)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PY6, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC1_DAT1 (SDMMC_DAT1)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PY5, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC1_DAT2 (SDMMC_DAT2)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PY4, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC1_DAT3 (SDMMC_DAT3)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PA6, GPIO_ENABLE, GPIO_LOW, GPIO_OUTPUT), // SDMMC3_CLK (WFMMC_CLK)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PA7, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC3_CMD (WFMMC_CMD)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PB7, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC3_DAT0 (WFMMC_DAT0)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PB6, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC3_DAT1 (WFMMC_DAT1)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PB5, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC3_DAT2 (WFMMC_DAT2)
	GPIO_CONFIG(NULL, TEGRA_GPIO_PB4, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // SDMMC3_DAT3 (WFMMC_DAT3)
	...
	GPIO_CONFIG(NULL, TEGRA_GPIO_PW7, GPIO_ENABLE, GPIO_LOW, GPIO_INPUT), // UART3_RXD (BT_UART_RXD)
