...
static struct ov5640_reg mode_initial[] = {
	...
	{OV5640_WRITE_REG, 0x5386, 0x81},
	{OV5640_WRITE_REG, 0x5387, 0x77},
	...
	// LSC
	{OV5640_WRITE_REG, 0x5800, 0x3F},
	{OV5640_WRITE_REG, 0x5801, 0x1C},
	{OV5640_WRITE_REG, 0x5802, 0x16},
	{OV5640_WRITE_REG, 0x5803, 0x15},
	{OV5640_WRITE_REG, 0x5804, 0x1C},
	{OV5640_WRITE_REG, 0x5805, 0x38},
	{OV5640_WRITE_REG, 0x5806, 0x11},
	{OV5640_WRITE_REG, 0x5807, 0x0B},
	{OV5640_WRITE_REG, 0x5808, 0x07},
	{OV5640_WRITE_REG, 0x5809, 0x07},
	{OV5640_WRITE_REG, 0x580A, 0x0A},
	{OV5640_WRITE_REG, 0x580B, 0x10},
	{OV5640_WRITE_REG, 0x580C, 0x0D},
	{OV5640_WRITE_REG, 0x580D, 0x04},
	{OV5640_WRITE_REG, 0x580E, 0x00},
	{OV5640_WRITE_REG, 0x580F, 0x00},
	{OV5640_WRITE_REG, 0x5810, 0x03},
	{OV5640_WRITE_REG, 0x5811, 0x0B},
	{OV5640_WRITE_REG, 0x5812, 0x0D},
	{OV5640_WRITE_REG, 0x5813, 0x04},
	{OV5640_WRITE_REG, 0x5814, 0x00},
	{OV5640_WRITE_REG, 0x5815, 0x00},
	{OV5640_WRITE_REG, 0x5816, 0x03},
	{OV5640_WRITE_REG, 0x5817, 0x0A},
	{OV5640_WRITE_REG, 0x5818, 0x13},
	{OV5640_WRITE_REG, 0x5819, 0x0B},
	{OV5640_WRITE_REG, 0x581A, 0x07},
	{OV5640_WRITE_REG, 0x581B, 0x06},
	{OV5640_WRITE_REG, 0x581C, 0x0A},
	{OV5640_WRITE_REG, 0x581D, 0x10},
	{OV5640_WRITE_REG, 0x581E, 0x3B},
	{OV5640_WRITE_REG, 0x581F, 0x1B},
	{OV5640_WRITE_REG, 0x5820, 0x17},
	{OV5640_WRITE_REG, 0x5821, 0x16},
	{OV5640_WRITE_REG, 0x5822, 0x1B},
	{OV5640_WRITE_REG, 0x5823, 0x33},
	{OV5640_WRITE_REG, 0x5824, 0x66},
	{OV5640_WRITE_REG, 0x5825, 0x08},
	{OV5640_WRITE_REG, 0x5826, 0x0A},
	{OV5640_WRITE_REG, 0x5827, 0x08},
	{OV5640_WRITE_REG, 0x5828, 0x48},
	{OV5640_WRITE_REG, 0x5829, 0x28},
	{OV5640_WRITE_REG, 0x582A, 0x26},
	{OV5640_WRITE_REG, 0x582B, 0x24},
	{OV5640_WRITE_REG, 0x582C, 0x24},
	{OV5640_WRITE_REG, 0x582D, 0x28},
	{OV5640_WRITE_REG, 0x582E, 0x28},
	{OV5640_WRITE_REG, 0x582F, 0x22},
	{OV5640_WRITE_REG, 0x5830, 0x40},
	{OV5640_WRITE_REG, 0x5831, 0x42},
	{OV5640_WRITE_REG, 0x5832, 0x06},
	{OV5640_WRITE_REG, 0x5833, 0x28},
	{OV5640_WRITE_REG, 0x5834, 0x26},
	{OV5640_WRITE_REG, 0x5835, 0x24},
	{OV5640_WRITE_REG, 0x5836, 0x24},
	{OV5640_WRITE_REG, 0x5837, 0x28},
	{OV5640_WRITE_REG, 0x5838, 0x68},
	{OV5640_WRITE_REG, 0x5839, 0x2A},
	{OV5640_WRITE_REG, 0x583A, 0x2A},
	{OV5640_WRITE_REG, 0x583B, 0x28},
	{OV5640_WRITE_REG, 0x583C, 0x26},
