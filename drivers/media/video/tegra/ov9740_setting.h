...
static struct ov9740_reg Exposure_Minus_Two[] = {
	{OV9740_WRITE_REG, 0x3A0F, 0x50},
	{OV9740_WRITE_REG, 0x3A10, 0x4C},
	{OV9740_WRITE_REG, 0x3A1B, 0x50},
	{OV9740_WRITE_REG, 0x3A1E, 0x4C},
	{OV9740_WRITE_REG, 0x3A11, 0xA0},
	{OV9740_WRITE_REG, 0x3A1F, 0x26},

	{OV9740_TABLE_END, 0x0000, 0x00},
};

static struct ov9740_reg Exposure_Minus_One[] = {
	{OV9740_WRITE_REG, 0x3A0F, 0x54},
	{OV9740_WRITE_REG, 0x3A10, 0x50},
	{OV9740_WRITE_REG, 0x3A1B, 0x54},
	{OV9740_WRITE_REG, 0x3A1E, 0x50},
	{OV9740_WRITE_REG, 0x3A11, 0xA0},
	{OV9740_WRITE_REG, 0x3A1F, 0x26},
...
static struct ov9740_reg Exposure_Plus_One[] = {
	{OV9740_WRITE_REG, 0x3A0F, 0x68},
	{OV9740_WRITE_REG, 0x3A10, 0x58},
	{OV9740_WRITE_REG, 0x3A1B, 0x68},
	{OV9740_WRITE_REG, 0x3A1E, 0x58},
	{OV9740_WRITE_REG, 0x3A11, 0xD0},
	{OV9740_WRITE_REG, 0x3A1F, 0x30},

	{OV9740_TABLE_END, 0x0000, 0x00},
};

static struct ov9740_reg Exposure_Plus_Two[] = {
	{OV9740_WRITE_REG, 0x3A0F, 0x78},
	{OV9740_WRITE_REG, 0x3A10, 0x68},
	{OV9740_WRITE_REG, 0x3A1B, 0x78},
